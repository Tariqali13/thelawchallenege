...
const apiURL = "http://localhost:6600";
...
export const handleSubmit = (e) => dispatch => {
    ...
    axios.post(`${apiURL}/send`, mails).then((res) => {
...
export const handleSubmit2 = (e) => dispatch => {
    ...
    axios.post(`${apiURL}/Reg`, Allmembers).then((res) => {
...
export const NewsSubmit = (e) => dispatch => {
    ...
    axios.post(`${apiURL}/News`, Newsdata).then((res) => {
