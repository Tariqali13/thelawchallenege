                    ...
                    <div className='contact_divider'>
                        <div className="contact_data main_para2 ">
                            <div className='heading3'>
                                <h5>We believe in keeping memories because they remind us of what happened in the Past and motivate us to do better or keep it up.</h5>
                                <p style={{ "textAlign": "center", "width": "100%" }}>Have a look at some of the winning and joyful moments not forgetting the sad ones too.</p>
